...
$result = json_encode(array("$result_key" => "$result_value"));

$curl = "PUT http://localhost:8080/activiti-rest/service/task/$task_id/$action_type";
$ch = curl_init("http://localhost:8080/activiti-rest/service/task/$task_id/$action_type");
