      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="process_definition.php">Process Definition List</a></li>
...
<?php
$curl = "GET http://localhost:8080/activiti-rest/service/process-definitions";
$ch = curl_init("http://localhost:8080/activiti-rest/service/process-definitions");
...
$output = curl_exec($ch);
curl_close($ch);
$process_definition = json_decode($output);
?>
      <h1>Activiti Rest Demo</h1>
	  <h4><?php echo($curl) ?></h4>
	  <br>
<?php
foreach ( $process_definition->data as $data )
{
	$id = $data->id;
	$key = $data->key;
	$name = $data->name;
	echo("<p><h4>Name : $name</h4><h5>Key : $key</h5><h5>Id : $id</h5></p>");
}
?>
