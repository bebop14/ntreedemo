...
<html lang="en">
  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="perform_task.php">Perform Task</a></li>
    ...
    <div class="container">
	  ...
	  <br>
		<form action="perform_task_result.php" method="post">
		  <fieldset>
			<legend>요청 처리 </legend>
			<label>Task Id</label>
			<input name="task_id" type="text" placeholder="">
			<label>처리 종류 (claim/unclaim/complete)</label>
			<input name="action_type" type="text" placeholder="">
			<label>결 과</label>
			<input name="result_key" type="text" placeholder="approved or result"> : <input name="result_value" type="text" placeholder="true or false">
			<br>
