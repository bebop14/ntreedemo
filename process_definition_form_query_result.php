        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="process_definition_form.php">Process Definition Form</a></li>
...
<?php
$process_definition_id = $_GET["process_definition_id"];
$curl = "GET http://localhost:8080/activiti-rest/service/process-definition/$process_definition_id/properties";
$ch = curl_init("http://localhost:8080/activiti-rest/service/process-definition/$process_definition_id/properties");
