        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="query_task_form.php">Query Task Form</a></li>
...
$curl = "GET http://localhost:8080/activiti-rest/service/form/$task_id/properties";
$ch = curl_init("http://localhost:8080/activiti-rest/service/form/$task_id/properties"); 
