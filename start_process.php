...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
	  ...
	  <br>
		<form action="start_process_form_result.php" method="post">
		  <fieldset>
			<legend>Process Definition Form </legend>
			<label>Process Definition Id</label>
			<input name="process_definition_id" type="text" placeholder="">
			<label>요청자</label>
			<input name="requester" type="text" placeholder="">
			<label>결재권자</label>
			<input name="assignee" type="text" placeholder="">
			<label class="checkbox">
				  <input name="createAccount" type="checkbox">서버 계정 생성 요청
			</label>
			<label>계정요청자</label>
			<input name="createAccountList" type="text" placeholder="">
			<label>접근사유</label>
			<input name="createAccountReason" type="text" placeholder="">
			<br>
